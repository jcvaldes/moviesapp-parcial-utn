export const ACTORS: any = {
  ...
  2: {
    ...
    sexo: 'M',
    fechaNacimiento: '1976-12-12',
    foto: 'https://m.media-amazon.com/images/M/MV5BMjExNzA4MDYxN15BMl5BanBnXkFtZTcwOTI1MDAxOQ@@._V1_UY1200_CR117,0,630,1200_AL_.jpg',
    paisOrigen: 'estados unidos'
  },
  3: {
    nombre: 'Paul',
    ...
    sexo: 'M',
    fechaNacimiento: '1976-12-12',
    foto: 'https://vignette.wikia.nocookie.net/fastandfurious/images/0/00/Paul.png/revision/latest/top-crop/width/720/height/900?cb=20150221185329',
    paisOrigen: 'estados unidos'
  }
};
